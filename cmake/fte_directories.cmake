...
set(FTE_ENGINE_D3D_DIR ${FTE_ENGINE_ROOT_DIR}/d3d)
...
set(FTE_ENGINE_SW_DIR ${FTE_ENGINE_ROOT_DIR}/sw)
set(FTE_ENGINE_VK_DIR ${FTE_ENGINE_ROOT_DIR}/vk)
set(FTE_ENGINE_HTTP_DIR ${FTE_ENGINE_ROOT_DIR}/http)
set(FTE_ENGINE_WEB_DIR ${FTE_ENGINE_ROOT_DIR}/web)
set(FTE_PLUGINS_ROOT_DIR ${FTE_ROOT_DIR}/plugins)
set(FTE_TOOLS_ROOT_DIR ${FTE_ROOT_DIR}/tools)

if(NOT FTE_INSTALL_PREFIX)
	set(FTE_INSTALL_PREFIX ${FTE_ROOT_DIR}/game)
endif()
