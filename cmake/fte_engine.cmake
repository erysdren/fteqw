...
set(FTE_ENGINE_CLIENT_SOURCES
	...
	$<$<BOOL:${WIN32}>:${FTE_ENGINE_CLIENT_DIR}/winquake.rc>
...
set(FTE_ENGINE_CLIENT_VK_SOURCES
	${FTE_ENGINE_VK_DIR}/vk_init.c
	${FTE_ENGINE_VK_DIR}/vk_backend.c
)

set(FTE_ENGINE_CLIENT_GL_SOURCES
	${FTE_ENGINE_GL_DIR}/gl_draw.c
	${FTE_ENGINE_GL_DIR}/gl_backend.c
	${FTE_ENGINE_GL_DIR}/gl_rmain.c
	${FTE_ENGINE_GL_DIR}/gl_rmisc.c
	${FTE_ENGINE_GL_DIR}/gl_rsurf.c
	${FTE_ENGINE_GL_DIR}/gl_screen.c
	${FTE_ENGINE_GL_DIR}/gl_bloom.c
	${FTE_ENGINE_GL_DIR}/gl_vidcommon.c
)
...
set(FTE_ENGINE_CLIENT_D3D_SOURCES
	${FTE_ENGINE_D3D_DIR}/d3d8_backend.c
	${FTE_ENGINE_D3D_DIR}/d3d8_image.c
	${FTE_ENGINE_D3D_DIR}/vid_d3d8.c
	${FTE_ENGINE_D3D_DIR}/d3d_backend.c
	${FTE_ENGINE_D3D_DIR}/d3d_image.c
	${FTE_ENGINE_D3D_DIR}/d3d_shader.c
	${FTE_ENGINE_D3D_DIR}/vid_d3d.c
	${FTE_ENGINE_D3D_DIR}/d3d11_backend.c
	${FTE_ENGINE_D3D_DIR}/d3d11_image.c
	${FTE_ENGINE_D3D_DIR}/d3d11_shader.c
...
if(FTE_ENGINE_BOTH)
	...
	target_compile_definitions(fteqw
		PRIVATE
			...
			$<$<EQUAL:${FTE_ENGINE_SDL_VERSION_MAJOR},3>:FTE_SDL3>
			$<$<STREQUAL:${FTE_ENGINE_RENDERER},gl>:GLQUAKE>
			$<$<STREQUAL:${FTE_ENGINE_RENDERER},vk>:VKQUAKE>
			$<$<STREQUAL:${FTE_ENGINE_RENDERER},sw>:SWQUAKE>
...
if(FTE_ENGINE_SERVER)
	...
	set_target_properties(fteqw-sv
		PROPERTIES
			...
			RUNTIME_OUTPUT_DIRECTORY ${FTE_INSTALL_PREFIX}
			SUFFIX ${FTE_EXECUTABLE_SUFFIX}
			OUTPUT_NAME ${FTE_ENGINE_SERVER_NAME}
	)
endif()
