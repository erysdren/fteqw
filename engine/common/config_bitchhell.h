// Build-Config file for BITCH HELL
// to use: make FTE_CONFIG=bitchhell
...
//general rebranding
#define DISTRIBUTION			"BH"							//should be kept short. 8 or less letters is good, with no spaces.
#define DISTRIBUTIONLONG		"Wifesoft Gameware"		//think of this as your company name. It isn't shown too often, so can be quite long.
#define FULLENGINENAME			"B I T C H  H E L L"						//nominally user-visible name.
#define ENGINEWEBSITE			"https://www.wifesoft-gameware.biz/"	//for shameless self-promotion purposes.
#define BRANDING_ICON			"bitchhell.ico"				//The file to use in windows' resource files - for linux your game should include an icon.[png|ico] file in the game's data.

//filesystem rebranding
#define GAME_SHORTNAME			"bitchhell"			//short alphanumeric description
#define GAME_FULLNAME			"B I T C H  H E L L" 	//full name of the game we're playing
#define GAME_BASEGAMES			"gamedata"	//comma-separate list of basegame strings to use
